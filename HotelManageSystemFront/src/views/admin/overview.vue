  ...
  <a-spin :spinning="showSpin">
    <div class="main">
      <a-row :gutter="[20, 20]">
        ...
        <a-col :sm="24" :md="12" :lg="5">
          <a-card size="small" title="完成订单">

            <template #extra>
              <a-tag color="orange" slot="extra">完成</a-tag>
            </template>

            <div class="box">
              <div class="box-top">
                <span class="box-value">{{ tdata.data.order_ok_count }}<span class="v-e">单</span></span>
              </div>
              <div class="box-bottom">
                <span>共 {{ tdata.data.order_ok_p_count }} 人</span>
              </div>
            </div>
          </a-card>
        </a-col>
